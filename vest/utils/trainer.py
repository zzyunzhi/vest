...
# from vest.optimizers import Fromage, Madam
from vest.utils.distributed import get_rank
from vest.utils.distributed import master_only_print as print
from vest.utils.init_weight import weights_init
# from vest.utils.model_average import ModelAverage
...
def get_model_optimizer_and_scheduler(cfg, seed=0):
    ...
    net_G = lib_G.Generator(cfg.gen, cfg.data).to(device)
    net_D = lib_D.Discriminator(cfg.dis, cfg.data).to(device)
