...
from vest.third_party.mine.operations.homography_sampler import HomographySample
from vest.third_party.mine.operations.rendering_utils import transform_G_xyz, sample_pdf, gather_pixel_by_pxpy
...
def render_tgt_rgb_depth(H_sampler: HomographySample,
    ...
    if extra_return:
        return tgt_rgb_syn, tgt_depth_syn, tgt_mask, tgt_rgb_BS3HW, tgt_sigma_BS1HW
